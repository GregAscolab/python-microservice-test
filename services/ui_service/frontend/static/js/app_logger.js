...
(function(window) {
    ...
    function initAppLoggerPage() {
        console.log("Initializing App Logger page...");

        // --- WebSocket Connections ---
        appLoggerSocket = ConnectionManager.getSocket('/ws_app_logger');
        appLoggerSocket.onmessage = onAppLoggerMessage;
    ...
    function onToggleRecording() {
        ...
        appLoggerSocket.send(JSON.stringify({ command: command }));
    ...
    function onAppLoggerMessage(event) {
    ...
    function cleanupAppLoggerPage() {
        ...
        ConnectionManager.closeSocket('/ws_app_logger');
